...
export default function SolutionGrid({
    ...
    return (
        <div className={`w-full bg-black text-white px-4 sm:px-6 py-12 ${className}`}>
            {/* Header Section */}
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 auto-rows-fr">
                {CapabilitySections.map((service, index) => (
                    <div
                        key={index}
                        className="rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-[#45C2CC] bg-black"
                    >
                        <div className="flex flex-col sm:flex-row h-full">
                            {/* Image Section */}
                            <div className="relative w-full sm:w-[45%] h-64 sm:h-auto flex-shrink-0 overflow-hidden bg-red-400">
                                <Image
                                    src={service.image}
                                    alt={service.title}
                                    fill
                            ...
                            <div className="w-full sm:w-[55%] p-6 sm:p-8 flex flex-col justify-center">
                                ...
                                {/* Title */}
                                <h3 className="text-xl sm:text-2xl font-semibold text-[#45C2CC] mb-4 leading-tight">
                                    {service.title}
                                </h3>
