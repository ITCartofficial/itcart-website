...
//                 ${isActive ? "lg:flex-[2] flex-auto " : "lg:flex-[1] flex-auto"} h-[400px] sm:h-[500px] md:h-[550px]`}
...
//                             {/* Bottom content */}
//                             <div className={`absolute w-full bottom-6 left-6 sm:bottom-8 sm:left-8 z-20 ${isActive && "bg-red-400"}`}>
...
//                                 {isActive && (
//                                     <p className="text-gray-200 text-sm sm:text-base leading-relaxed mt-1 w-[90%] sm:w-[80%] md:w-[80%] lg:w-[90%]">
//                                         {item.description}
//                                     </p>
//                                 )}
//                             </div>
