...
const ContentfulSection: React.FC<ContentfulSectionProps> = ({ title, description, bgImage }) => {
    ...
    return (
        <div className='w-full h-max lg:min-h-[500px] bg-cover bg-no-repeat rounded-[85px] overflow-hidden' style={{ backgroundImage: `url(${bgImage})` }}>
            <div className="w-full h-full" style={{ background: 'linear-gradient(-90deg, rgba(0, 0, 0, 0.00) 0%, #000 85%)' }}>
                <div className="container mx-auto lg:px-10 lg:py-16 h-full flex flex-col gap-4 justify-center">
