    ...
    return (
        <footer className="bg-black  text-white py-4 md:py-10 lg:py-12 relative overflow-none border-t border-[#424242]">
            <div className="flex flex-col lg:flex-row ">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-between bg-black">

                    {/* ✅ Logo (now aligns left on lg screens, centered on mobile) */}
                    <div className="w-full flex justify-center lg:justify-start mb-5 mt-5 md:mt-0">
                        <div className="ml-0 lg:ml-23">
                            <Logo />
                        </div>
                    </div>

                    {/* ✅ Title (aligned like the logo) */}
                    <div className="w-full flex justify-center lg:justify-start">
                        <GradientTitle
                            text="Smart Solutions for a Smarter Tomorrow"
                            lineHeight="1.2"
                            className="max-w-lg text-[28px] sm:text-[32px] lg:text-[45px] text-center lg:text-left mt-3 px-10 lg:px-0 lg:ml-22"
                            theme="dark"
                        />
                    </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-10 items-center lg:items-start">
                    ...
                    <div className="flex justify-center lg:justify-end w-full">
                        <SocialIcons size={21} color="#ffffff" className="mr-22" socialMedia={socialLinks} />
                    </div>
