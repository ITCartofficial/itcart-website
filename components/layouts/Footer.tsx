...
//     return (
//         <footer className="bg-black w-screen text-white py-4 md:py-10 lg:py-12 relative overflow-hidden bg-blue-400">
//             <div className="container mx-auto flex flex-col lg:flex-row">
//                 {/* Left Side – Logo, Title, Image */}
//                 <div className="w-full lg:w-1/2 flex flex-col justify-between items-center lg:items-start bg-red-400">
//                     {/* Logo */}
...
//                     <div className="relative w-full max-w-[1200px] mx-auto mt-4 overflow-hidden rounded-lg bg-red-400">
//                         <Image
...
//                 <div className="w-full lg:w-1/2 flex flex-col gap-10 items-center lg:items-start bg-green-400">
//                     {/* Social Icons */}
        ...
        <footer className="bg-black  text-white py-4 md:py-10 lg:py-12 relative overflow-none border-t border-[#424242]">
            <div className="flex flex-col lg:flex-row ">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-10 items-center lg:items-start">
                    {/* Social Icons */}
                    <div className="flex justify-center lg:justify-end w-full">
                        <SocialIcons size={21} color="#ffffff" className="md:mr-20" socialMedia={socialLinks} />
                    </div>
