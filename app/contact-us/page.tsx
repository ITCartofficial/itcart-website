  ...
  return (
    <div className="flex flex-col  lg:h-full bg-black pt-16 lg:pt-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-10 lg:w-1/2 flex flex-col items-center justify-center py-8 lg:py-16">
        ...
        <BodyText text="Stay ahead with AI-powered solutions tailored to your needs. Connect with IT Cart experts through our contact form to explore what&apos;s possible." color="#ffffff" className="text-center text-[18px] lg:text-[20px] w-[80%]" />
      </div>
