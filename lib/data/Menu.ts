...
export const navItems = [
  ...
  { label: "Consult Now", href: "/consultnow" },
  {
    ...
    submenu: [
      ...
      { label: "RCMAiX", href: "/our-verticals/RCMAiX" },
      { label: "AiXERP", href: "/our-verticals/AiXERP" },
      { label: "AiXGRC", href: "/our-verticals/AiXGRC" },
      { label: "CyberAiX", href: "/our-verticals/CyberAiX" },
      { label: "AiXHEAT", href: "/our-verticals/AiXReality" },
      { label: "AiXReality", href: "/our-verticals/AiXReality" },
      { label: "AiXMotorsports", href: "/our-verticals/AiXMotersports" },
      { label: "AiXEnergy", href: "/our-verticals/AiXEnergy" },
    ],
  },
  {
    label: "Solutions", href: "/solutions",
    submenu: [
      { label: "AiXHubtm internet", href: "/solutions/AiXHub™-Internet" },
      ...
      { label: "Human Resource Management", href: "/solutions/Human-Resource-Management" },
      ...
      { label: "Customer Relationship Management", href: "/solutions/Customer-Relationship-Management" },
      { label: "Supply Chain Management", href: "/solutions/Supply-Chain-Management" },
      { label: "Logistics Management", href: "/solutions/Logistics-Management" },
      { label: "Governance,Risk & Compliance", href: "/solutions/Governance,-Risk&-Compliance" },
      { label: "Financial Business Intelligence", href: "/solutions/Financial-Business-Intelligence" },
    ]
  },
  {
    label: "Industry", href: "/industry",
    submenu: [
      { label: "Airlines", href: "/industry/Airlines" },
      { label: "Automotive", href: "/industry/Automotive" },
      { label: "Banking & Finance", href: "/industry/Banking-&-Finance" },
      { label: "Digital Marketing", href: "/industry/Digital-Marketing" },
      { label: "Education", href: "/industry/Education" },
      { label: "Engineering & Construction", href: "/industry/Engineering-&-Construction" },
      { label: "Food & Beverages", href: "/industry/Food-&-Beverages" },
      { label: "FMCG", href: "/industry/FMCG" },
      { label: "Industrial & Manufacturing", href: "/industry/Industrial-&-Manufacturing" },
      { label: "Healthcare", href: "/industry/Healthcare" },
      { label: "Information Technology", href: "/industry/Information-Technology" },
      { label: "Media & Telecommunication", href: "/industry/Media-&-Telecommunication" },
      ...
      { label: "Transportations & Logistics", href: "/industry/Transportations-&-Logistics" },
