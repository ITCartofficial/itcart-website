            ...
            CapabilitySections: [
                {
                    ...
                    description: "Automate invoicing, payments, ledgers, and compliance. Get real-time visibility into cash flow, budgets, and profits with the help of powerful AI-powered ERP solutions. ",
                    gradient: "from-[#45C2CC] to-[#181919]", // teal to blue
                },
                {
                    title: "Inventory and procurement",
                    description: "Track inventory across warehouses, manage procurement cycles, and reduce stockouts or overages with AI-powered demand forecasting. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Human resource management",
                    description: "Digitize payroll, leave, recruitment, onboarding, and performance tracking. Empower HR with self-service portals and employee insights by leveraging Artificial Intelligence in ERP. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Operations and workflow automation",
                    description: "Standardize your day-to-day processes and automate routine tasks. Use AiXERP as your ERP system for workflow automation to improve efficiency and monitor KPIs across departments. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                // {
                //     title: "Conversational Interfaces ",
            ...
            skillGapSection: [
                {
                    ...
                    highlight: "Startups to global organizations seeking scalable, intelligent business solutions. ",
                    description: "",
                ...
                },
                {
                    icon: '/images/vertical/icons/handicons.png',
                    title: "Finance Teams",
                    highlight: "Professionals requiring automated accounting, compliance, and cash flow management. ",
                    description: "",
                ...
                },
                {
                    ...
                    highlight: "Leaders streamlining workflows, reducing manual work, improving efficiency. ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",
                }
            ],
            ...
            CapabilitySections: [
                {
                    ...
                    description: "Real-time AI-powered fraud detection using advanced machine learning algorithms that adapt to emerging threats.  ",
                    gradient: "from-[#45C2CC] to-[#181919]", // teal to blue
                },
                {
                    title: "Automated Compliance Management ",
                    description: "Embedded regulatory compliance engine ensuring adherence to GDPR, HIPAA, DPDP, and financial industry standards. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "AI-Driven Credit Scoring",
                    description: "Advanced predictive analytics for alternative credit assessment, processing diverse data sources for accurate lending decisions",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Autonomous Transaction Processing ",
                    description: "Smart contract execution and automated payment workflows reducing manual intervention by 70-85%.  ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Intelligent Document Automation",
                    description: "OCR and NLP-powered document processing for KYC, loan applications, and regulatory reporting. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Real-Time Financial Analytics",
                    description: "Predictive insights dashboard providing actionable intelligence for investment decisions and portfolio optimization.  ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                }
            ],
            skillGapSection: [
                {
                    ...
                    highlight: "Cost optimization through 30-50% operational expense reduction and 75% total ownership cost savings. ",
                    description: "",
                    gradient: "from-[#45C2CC] to-[#181919]",   // add gradient
                },
                {
                    ...
                    highlight: "Enhanced risk management with 90-98% error reduction and 93% faster threat detection capabilities",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",   // add gradient
                },
                {
                    ...
                    highlight: "Infrastructure consolidation replacing 5-10 fragmented tools with unified AI-native platform.  ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",   // add gradient
                },
            ],
            ...
            CapabilitySections: [
                {
                    ...
                    description: "Rapid threat classification and containment using advanced machine learning algorithms.",
                    gradient: "from-[#45C2CC] to-[#181919]", // teal to blue
                },
                {
                    title: "Security Co-Pilot",
                    description: "Real-time threat summaries, automated triage, and intelligent analyst augmentation systems. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Microsoft Sentinel Integration",
                    description: "Unified SIEM/SOAR platform with extended telemetry across multicloud environments.",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Red Team Simulations",
                    description: "Advanced adversary attack simulations uncovering unknown vulnerabilities and weaknesses. ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                // {
                //     title: "Conversational Interfaces ",
            ...
            skillGapSection: [
                {
                    ...
                    highlight: "CISOs and security architects implementing comprehensive enterprise threat protection strategies.",
                    description: "",
                    gradient: "from-[#45C2CC] to-[#181919]",
                },
                {
                    ...
                    highlight: "SOC analysts requiring automated threat detection and intelligent incident response capabilities. ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",
                },
                {
            ...
            CapabilitySections: [
                {
                    ...
                    description: "Get tuned to a unified patient dashboard that offers real-time clinical insights with patient engagement tools, enabling personalized health.  recommendations.  ",
                    gradient: "from-[#45C2CC] to-[#181919]", // teal to blue
                },
                {
                    title: "AI-Powered Diagnostic Excellence ",
                    description: "With AiXLifeCare, you benefit from features like early disease detection, advanced pattern recognition, and automated diagnostic reporting.  ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                }
            ],
            skillGapSection: [
                {
                    ...
                    highlight: "Streamline operations with comprehensive AI platform for multispecialty hospitals ",
                    description: "",
                    gradient: "from-[#45C2CC] to-[#181919]",   // add gradient
                },
                {
                    ...
                    highlight: "Optimize workflows and ensure compliance with intelligent automation ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",   // add gradient
                },
                {
                    ...
                    highlight: "Enhanced diagnostic accuracy through AI clinical decision support   ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",   // add gradient
                },
            ],
    ...
    },
    {
        ...
        detailPage: {
            ...
            aboutSection: {
                ...
                contentfour: 'AiXHeat replaces 5-8 traditional HVAC management tools with one unified AI-driven system that emulates the decision-making of facility managers and the operational efficiency of engineering teams. '
            },
            CapabilitySections: [
                {
                    title: "Predictive Climate Optimization",
                    description: "AI-powered thermal modeling preventing equipment failures by 95% ",
                    gradient: "from-[#45C2CC] to-[#181919]", // teal to blue
                },
                {
                    title: "Smart Energy Management",
                    description: "Real-time consumption optimization reducing HVAC costs by 40% ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Autonomous Maintenance Orchestration",
                    description: "Predictive maintenance alerts preventing costly breakdowns and emergency repairs ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Occupancy-Based Temperature Control",
                    description: "Dynamic climate adjustment based on real-time occupancy patterns ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Multi-Zone Coordination Engine",
                    description: "Synchronized HVAC operations across building zones for optimal efficiency ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
                {
                    title: "Compliance Monitoring System",
                    description: "Automated environmental standards adherence and reporting capabilities ",
                    gradient: "from-[#222222] to-[#111111]", // dark
                },
            ],
            skillGapSection: [
                {
                    ...
                    highlight: "Streamline multi-zone climate control and maintenance operations ",
                    description: "",
                    gradient: "from-[#45C2CC] to-[#181919]",   // add gradient
                },
                {
                    ...
                    highlight: "Optimize energy costs across diverse property portfolios ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",   // add gradient
                },
                {
                    ...
                    highlight: "Enhance predictive maintenance and customer service capabilities ",
                    description: "",
                    gradient: "from-[#222222] to-[#111111]",   // add gradient
                },
            ],
